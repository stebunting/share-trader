        ...
        for portfolio in portfolios:
            ...
            for share in updated_shares:
                if share['portfolioid'] == session['portfolio']:
                    ...
                    html += '<tr><td><a href="https://share-trader.onrender.com/shares?submit=update&id={}">{}</a></td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td><td>{}</td></tr>'.format(share['id'], share['epic'], shareprice(share['target']), shareprice(share['stoploss']), shareprice(share['sellprice']), shareprice(share['sellprice'] - share['bidopen'], profitloss=True), gbp(share['value']), gbp(share['profitloss'], profitloss=True), percentage(share['percentage']))
            html += '</tbody></table>'
